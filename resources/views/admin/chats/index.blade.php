    ...
    <div class="container-fluid">
        ...
        <div class="page-header">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="{{ route('admin.chats.initiate') }}" class="btn btn-success">
                        <i class="bi bi-plus-circle"></i> Initiate Chat
                    </a>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-lg-6 col-xl-4 mb-4">
                                    <div class="chat-card card h-100 {{ $chat->status === 'open' ? 'border-primary' : '' }}">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($chat->messages->count() > 0)
                                                <div class="mb-3">
                                                    ...
                                                    <small
                                                        class="text-muted">{{ $chat->messages->last()->created_at->format('M d, Y g:i A') }}</small>
                                                </div>
                                            @endif
                                            ...
                                            @if($chat->messages->where('is_read', false)->count() > 0)
                                                <div class="mb-3">
                                                    <span
                                                        class="badge bg-danger">{{ $chat->messages->where('is_read', false)->count() }}
                                                        new messages</span>
                                                </div>
                                            @endif
                                        </div>
                                        <div class="card-footer">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex gap-1">
                                                    <a href="{{ route('admin.chats.show', $chat) }}" class="btn btn-primary btn-sm">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.chats.export', $chat) }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="admin_notes" id="admin_notes" class="form-control" rows="3"
                                placeholder="Brief summary of how the issue was resolved..."></textarea>
                        </div>
                    </div>
