        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    <a href="{{ route('home') }}" class="btn btn-lg fw-semibold text-white border-white" style="background: transparent; border-radius: 12px; padding: 15px 30px; white-space: nowrap;">
                        <i class="fas fa-home me-2"></i>Go to Home
                    </a>
                    <a href="#" class="btn btn-lg fw-semibold" style="background: #F5EEE4; color: #5D2B4C; border-radius: 12px; padding: 15px 30px; white-space: nowrap;">
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
                ...
                <button class="btn btn-lg fw-semibold text-white" style="background: #5D2B4C; border-radius: 12px; padding: 15px 30px; white-space: nowrap;">
                    Learn More About Us
                </button>
            </div>
            <div class="col-lg-6 col-md-12 text-center">
        ...
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-12 mb-4 mb-lg-0">
                ...
                <div class="d-flex gap-3 flex-wrap">
                    ...
                    <a href="#" class="btn btn-lg fw-semibold" style="background: white; color: #5D2B4C; border-radius: 12px; padding: 15px 30px; white-space: nowrap;">
                        <i class="fas fa-info-circle me-2"></i>Learn More
                    </a>
                </div>
            </div>
