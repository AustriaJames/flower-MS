        ...
        <div class="col-12">
            ...
            <div class="text-center mb-5">
                <div class="category-hero mb-4">
                    <div class="category-image mx-auto" style="width: 200px; height: 200px; background: #F0F2F5; border-radius: 50%; display: flex; align-items: center; justify-content: center; overflow: hidden; box-shadow: 0 10px 30px rgba(93, 43, 76, 0.1);">
                        @if($category->image)
                ...
                <h2 class="fw-bold mb-3" style="color: #5D2B4C;">{{ $category->name }}</h2>
